...
txt_base="/home/alta/BLTSpeaking/exp-pr450/lent_logs/baseline_posterior_distillation_100/log_${txt_base_tag}_"
...
declare -a densenet_lrs=(0.001 0.01)
declare -a byol_lrs=(0.000001 0.00001 0.0001)
declare -a training_modes=("posterior_distillation_multitask" "posterior_distillation" "entropy_log_mse" "lc_histogram_jacobian_bce")
# declare -a multitask_training_modes=( "lc_histogram_jacobian_bce" "entropy_log_mse" "None")
declare -a multitask_training_modes=( "lc_histogram_jacobian_bce" "None")
declare -a byol_dafs=("" "--byol_daf")
declare -a distillation_temperatures=("2.5")
declare -a multitask_acquisition_target_weights=("0.9")
