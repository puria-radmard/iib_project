...
run_path="/home/alta/BLTSpeaking/exp-pr450/lent_shell_scripts/baseline_posterior_distillation/run_train_regression_10.sh"
txt_base="/home/alta/BLTSpeaking/exp-pr450/lent_logs/second_baseline_posterior_distillation_10/log_${txt_base_tag}_"
...
declare -a training_modes=("entropy_soft_rank" "lc_soft_rank" "entropy_histogram_jacobian_bce" "posterior_distillation_multitask")
declare -a multitask_training_modes=("entropy_soft_rank" "lc_soft_rank" "entropy_histogram_jacobian_bce" "None")
declare -a byol_dafs=("") # "--byol_daf")
declare -a distillation_temperatures=("3.5")
            ...
            do
                ...
                do
                    ...
                    then
                        ...
                        do
                            if [[ $training_mode != *"rank"* && $mtm != *"rank"* ]]
                            then
                                $run_path "${txt_base}_${i}_${byol_daf:2}.txt" $lr $training_mode $mtm $dtemp $matw $byol_daf
                                i=$((i+1))
                            fi
