...
parser.add_argument("--metric_function", required=True, type=str, choices=['classification'], default='classification')
...
if __name__ == '__main__':
    ...
    agent, train_image_dataset, round_cost, total_budget, *_ = set_up_active_learning(args, classification=True)
    ...
    dataloader_init_method = lambda ds, bs: ClassificationDAFDataloader(ds, collate_fn=None, batch_size=bs, num_workers=4)
